...
Gunshot detection is one of the most time-critical tasks an acoustic surveillance system can perform. Missing a gunshot has consequences. This project asks: how capable can a threat detector be when constrained to hardware that could realistically be deployed at the edge?
